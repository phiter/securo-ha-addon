...
AGENTS_BUILTIN_MCP_URL="http://localhost:8765/mcp"
...
export STORAGE_LOCAL_PATH AGENTS_KNOWLEDGE_STORAGE_PATH AGENTS_EMBEDDING_MODELS_PATH AGENTS_BUILTIN_MCP_URL
